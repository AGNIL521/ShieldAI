# Adversarial Training Demo for Image Classifier
import numpy as np
...
print(f'Adversarially trained accuracy on clean: {accuracy_score(y_test, y_pred_clean):.2f}')
print(f'Adversarially trained accuracy on adversarial: {accuracy_score(y_test, y_pred_adv):.2f}')
